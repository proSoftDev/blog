                    ...
                    <form method="POST" action="{{ route('register') }}" class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary @error('name') has-danger @enderror">
                                    <label class="control-label">@lang('Имя') <span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control @error('name') form-control-danger @enderror"
                                           placeholder="@lang('Введите имя')" value="{{ old('name') }}" autocomplete="name" autofocus>
                                    @error('name')
                                ...
                                <div class="form-group form-primary @error('password') has-danger @enderror">
                                    ...
                                    <input type="password" name="password" class="form-control @error('password') form-control-danger @enderror"
                                           placeholder="@lang('Введите пароль')" autocomplete="new-password">
                                    @error('password')
                                        <div class="col-form-label">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group form-primary @error('password') has-danger @enderror">
                                    <label class="control-label">@lang('Пароль') <span class="text-danger">*</span></label>
                                    <input type="password" name="password_confirmation" class="form-control @error('password') form-control-danger @enderror"
                                           placeholder="@lang('Введите пароль')" autocomplete="new-password">
                                    @error('password')
                                        <div class="col-form-label">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        <div class="forgot-phone text-right f-right">
                                            Вернуться к
                                            <a href="{{ route('login') }}" class="text-right f-w-600">@lang('авторизации')</a>
                                        </div>
                                    </div>
                                </div>
